 ...
 * Cron: verifica FeedbackRecords comparando o nome atual com o esperado.
 * Restaura qualquer divergência, independente do universo fictício usado.
 * Loga no SecurityLog apenas quando há correções.
 */
