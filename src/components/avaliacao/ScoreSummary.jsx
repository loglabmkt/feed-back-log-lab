...
export const BANDS = {
  immediate_action: {
    ...
    label: "Ação Imediata",
    range: "10 – 15",
    action: "Alerta de PIP – Plano de Melhoria de Performance",
    bg: "bg-red-50",
  ...
  attention: {
    ...
    label: "Atenção",
    range: "16 – 22",
    action: "Sugerir 1:1 focado em suporte e acompanhamento",
    bg: "bg-amber-50",
  ...
  adequate: {
    ...
    label: "Adequado",
    range: "23 – 32",
    action: "Sugerir manutenção e evolução contínua",
    bg: "bg-blue-50",
  ...
  reference: {
    ...
    label: "Referência",
    range: "33 – 40",
    action: "Sugerir plano de carreira acelerado / Promoção",
    bg: "bg-emerald-50",
